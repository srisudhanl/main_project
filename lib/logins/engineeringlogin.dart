...
import 'package:main_project/pages/engineer.dart';
import 'package:main_project/querypage.dart';
import 'package:main_project/registers/engineeringregister.dart';
...
class _engineeringloginState extends State<engineeringlogin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:AppBar(
        title: Text('OVPC-engineeringlogin',
          style: TextStyle(
                          ...
                          ElevatedButton(
                              ...
                              onPressed:()async{
                                ...
                                try{
                                  ...
                                  //if(user!= null){
                                    Navigator.push(
                                      context,MaterialPageRoute(builder:(context)=>engineer())
                                  );}//}
                                catch(e){print(e);}
                          ...
                          Padding(
                            ...
                            child: Container(
                                child:TextButton(
                                  ...
                                  onPressed: (){
                                    Navigator.push(
                                        context,MaterialPageRoute(builder:(context)=>engineeringregister()));
                                  },
                                )
                            ),
                          ),
